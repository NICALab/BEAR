...
Official source codes for ["Efficient neural network approximation of robust PCA for automated analysis of calcium imaging data"](https://arxiv.org/abs/2108.01665), arXiv  [[1]](#ref).
